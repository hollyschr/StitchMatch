...
def fetch_by_category(api_user, api_pass, db_connection, project_type, craft_name, min_pattern_id=0):
    ...
    PAGE_SIZE = 50 
    MAX_PAGES = 200  # Still fetch up to 200
    START_PAGE = 61  # Start at page 61
...
def main():
    ...
    DB_PATH = 'StitchMatch.db'  # Updated to use the correct database name
    ...
    try:
        # Get the highest pattern ID currently in the database
        min_pattern_id = get_highest_pattern_id(con)
